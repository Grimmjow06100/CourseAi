...
func TestLoadWorkerConfigReadsEnvironmentStrictly(t *testing.T) {
	setWorkerEnvironment(t, map[string]string{
		...
		"GENERATION_JOB_RECONCILIATION_BATCH":  "25",
		"GENERATION_RETENTION_ENABLED":         "true",
		"GENERATION_RETENTION_PERIOD":          "24h",
		"GENERATION_RETENTION_INTERVAL":        "1h",
		"GENERATION_RETENTION_BATCH":           "20",
		"GENERATION_METRICS_INTERVAL":          "30s",
...
func setWorkerEnvironment(t *testing.T, values map[string]string) {
	...
	keys := []string{
		...
		"GENERATION_JOB_RECONCILIATION_BATCH",
		"GENERATION_RETENTION_ENABLED",
		"GENERATION_RETENTION_PERIOD",
		"GENERATION_RETENTION_INTERVAL",
		"GENERATION_RETENTION_BATCH",
		"GENERATION_METRICS_INTERVAL",
